<#
    ...
    PS> Disable-GitWorkflow <autocompleted_workflow>

    .EXAMPLE

    Enable a workflow for the another repository:

    PS> Disable-GitWorkflow -Repository <autocomplete_repo> <autocompleted_workflow>

    .EXAMPLE

    Enable a workflow for the a repository in another account:

    PS> Disable-GitWorkflow -Account <autocompleted_account> <autocomplete_repo> <autocompleted_workflow>
    ...
    PS> Disable-GitWorkflow -Account <autocompleted_account> -Context <autocomplete_context> <autocomplete_repo> <autocompleted_workflow>
...
function Disable-GitWorkflow {
    ...
    $Request = @{
        Method  = "PUT"
        Account = $repositoryData.Account
        API     = "/repos/$($repositoryData.full_name)/actions/workflows/$($workflowObject.id)/disable"
        Body    = @{
