...
FunctionsToExport = 'Install-Software', 'Prompt', 'Push-Profile', 'Get-DallEFromJoke', 
               'Get-OpenAIAPIAuthentication', 'Invoke-DalleRequest', 
               'Invoke-OpenAICompletion', 'Invoke-OpenAIImageGeneration', 
               'Invoke-OpenAIMoodToColor', 'Get-BlenderFiles', 'Open-BlenderFile', 
               ...
               'Switch-Terraform', 'Start-Fireworks', 'Start-GenericGameLoop', 
               'Start-InvadersGame', 'Start-SnakeGame', 'New-TetrisGame', 
               'Invoke-GitClone', 'Invoke-GitWrapper', 'Open-Repository', 
               'New-WindowBindings', 'New-WindowWPF'
...
AliasesToExport = 'openAiImage', 'moodToColor', 'git-clone', 'git-wrapper', 'git-open'
