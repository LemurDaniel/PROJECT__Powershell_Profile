...
FunctionsToExport = 'Get-Property', 'Join-PsObject', 'Search-In', 'Add-CodeEditor', 
               ...
               'Set-UtilsCache', 'Set-UtilsConfiguration', 
               'Invoke-AutoCompleterFileName', 'ConvertTo-RGB', 
               'Get-ANSIEscapeSequences', 'New-ANSIEscapeCode', 'New-RandomBytes', 
               'Open-InCodeEditor', 'Read-UserInput', 'Read-UserOption', 
               'Select-ConsoleMenu', 'Show-ConsoleImage', 
