...
FunctionsToExport = 'Install-Stuff', 'Convert-SecretObject', 'Get-SecretFromStore', 
               'Get-SecretsFromStore', 'Get-SecretStore', 'Set-VersionActiveTF', 
               'Update-SecretStore', 'Get-DailyMsRewards', 'Get-MsRewards', 
               'Get-ScrambledText', 'Prompt', 'Push-Profile', 'Switch-Terraform', 
               'Get-BlenderFiles', 'Open-BlenderFile', 'New-TetrisGame', 
...
AliasesToExport = 'tf', 'openAiImage', 'moodToColor'
