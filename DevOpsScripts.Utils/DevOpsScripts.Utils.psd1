...
FunctionsToExport = 'Get-Property', 'Join-PsObject', 'Search-In', 'Format-SendGridContent', 
               'Format-SendGridResourceReport', 'Send-SendGridEmail', 
               'New-SendGridHtmlFormat', 'ConvertTo-RGB', 'Get-ANSIEscapeSequences', 
               ...
               'Start-LoadingCircleAnimation', 'Invoke-AutoCompleterFileName', 
               ...
               'Convert-TFVarsToObject', 'Get-TerraformProviderInfo', 
               'Get-TerraformProviders', 'Get-TerraformVersions', 
               'New-TerraformReadmeLoro', 'Open-TerraformProviderDocs', 
               'Remove-MovedBlocks', 'Remove-TerraformState', 'Set-Terraform', 
               ...
               'Get-TerraformModuleCalls', 'Get-TerraformModuleCallsOld', 
               'Get-TerraformModuleResources', 'New-TerraformAzureImportStatement', 
               ...
               'Set-UtilsCache', 'Set-UtilsConfiguration', 'Add-CodeEditor', 
               'Add-ConsoleTestImages', 'Clear-CodeEditor', 'Edit-RegexOnFiles', 
               'Get-CodeEditor', 'Get-ConsoleTestImages', 'Remove-InvisibleUnicode', 
               'Switch-DefaultCodeEditor', 'Test-IsRepository'
...
AliasesToExport = 'Select-Property', 'property', 'get', 'Search-PreferencedObject', 
               'Search', 'k8s-exec', 'k8s-logs', 'k8s-explain', 'k8s-expl', 'k8s-describe', 
               'k8s-cluster', 'k8s-ns', 'tfDocs', 'staterm', 'tf', 'tf-import'
