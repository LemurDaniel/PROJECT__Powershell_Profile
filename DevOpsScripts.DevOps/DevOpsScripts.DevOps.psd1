...
FunctionsToExport = 'Edit-RegexOnFiles', 'Get-RecentSubmoduleTags', 'Get-RepositoryRefs', 
               'Invoke-DevOpsRest', 'New-AutomatedTag', 'New-PullRequest', 
               'Remove-AutomatedTags', 'Remove-MovedBlocks', 
               'Start-PipelineOnBranch', 'Start-Pipelines', 
               'Start-PipelinesBySearch', 'Start-PipelinesInOrder', 
               'Update-ModuleSources', 'Update-ModuleSourcesAllRepositories', 
               'Get-ProjectInfo', 'Get-RepositoryInfo', 'Show-DevOpsContext', 
               'Switch-Organization', 'Switch-Project', 'Get-PAT', 'New-Pat', 
               'Search-Pat', 'Update-Pat', 'Convert-SecretObject', 
               'Get-SecretFromStore', 'Get-SecretsFromStore', 'Get-SecretStore', 
               'Update-SecretStore', 'Open-Repository', 'Get-AzureDevOpsCache', 
               'Get-CurrentUser', 'Get-DevOpsCurrentContext', 
               'Get-DevOpsOrganizations', 'Get-DevOpsProjects', 'Get-Pipelines', 
               'Set-DevOpsCurrentContext', 'Get-GithubRepositories', 
...
AliasesToExport = '''Set-OrgContext''', '''swo''', '''Set-ProjectContext''', '''swp''', 
               '''VC''', '''VCP''', '''gitW'''
