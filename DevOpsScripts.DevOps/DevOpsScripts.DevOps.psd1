...
FunctionsToExport = 'Invoke-DevOpsRest', 'Edit-RepositoriesForRedeployment', 
               ...
               'New-PullRequest', 'New-Repository', 'Open-Repository', 
               'Open-RepositoryInBrowser', 'Remove-MovedBlocksAllRepositories', 
               'Start-RepositoryImport', 'Update-ModuleSourcesAllRepositories', 
               'Update-ModuleSourcesInPath', 'New-AutomatedTag', 
               'Remove-AutomatedTags', 'Get-DevOpsPAT', 'New-DevOpsPAT', 
               ...
               'Switch-Project', 'Switch-QuickContext', 'Get-BuildLogs', 
