...
FunctionsToExport = 'Edit-RegexOnFiles', 'Get-RecentSubmoduleTags', 'Get-RepositoryRefs', 
               'Invoke-DevOpsRest', 'New-MasterPR', 'New-PullRequest', 
               'Remove-MovedBlocks', 'Update-ModuleSourcesAllRepositories', 
               'Update-ModuleSourcesInPath', 'Get-ProjectInfo', 'Get-RepositoryInfo', 
               'Show-DevOpsContext', 'Switch-Organization', 'Switch-Project', 
               'Switch-QuickContext', 'Get-PAT', 'New-Pat', 'Search-Pat', 'Update-Pat', 
