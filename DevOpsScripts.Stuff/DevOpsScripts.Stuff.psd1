...
FunctionsToExport = 'Install-Software', 'Prompt', 'Push-Profile', 'Invoke-GitClone', 
               'Open-Repository', 'Start-Fireworks', 'Start-GenericGameLoop', 
               'Start-InvadersGame', 'Start-SnakeGame', 'New-TetrisGame', 
               'New-WindowBindings', 'New-WindowWPF', 'Get-DallEFromJoke', 
               'Get-OpenAIAPIAuthentication', 'Invoke-DalleRequest', 
               'Invoke-OpenAICompletion', 'Invoke-OpenAIImageGeneration', 
               'Invoke-OpenAIMoodToColor', 'Get-DailyMsRewards', 'Get-MsRewards', 
               'Get-ScrambledText', 'Switch-Terraform', 'Get-BlenderFiles', 
               'Open-BlenderFile', 'Convert-SecretObject', 'Get-SecretFromStore', 
