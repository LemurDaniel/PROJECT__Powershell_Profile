...
FunctionsToExport = 'Install-Software', 'Prompt', 'Push-Profile', 'Get-DailyMsRewards', 
               ...
               'Start-SnakeGame', 'New-TetrisGame', 'New-WindowBindings', 
               'New-WindowWPF', 'Convert-SecretObject', 'Get-SecretFromStore', 
               'Get-SecretsFromStore', 'Get-SecretStore', 'Set-VersionActiveTF', 
               'Update-SecretStore', 'Invoke-GitClone', 'Open-Repository', 
