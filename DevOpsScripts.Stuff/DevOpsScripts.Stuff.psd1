...
FunctionsToExport = 'Install-Software', 'Prompt', 'Push-Profile', 'Get-DailyMsRewards', 
               ...
               'Set-VersionActiveTF', 'Update-SecretStore', 'Get-DallEFromJoke', 
               'Get-OpenAIAPIAuthentication', 'Invoke-DalleRequest', 
               'Invoke-OpenAICompletion', 'Invoke-OpenAIImageGeneration', 
               'Invoke-OpenAIMoodToColor', 'New-WindowBindings', 'New-WindowWPF', 
               'Get-BlenderFiles', 'Open-BlenderFile', 'Start-Fireworks', 
