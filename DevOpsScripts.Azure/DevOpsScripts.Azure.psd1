...
AliasesToExport = 'k8s-exec', 'k8s-logs', 'k8s-describe', 'k8s-cluster', 'k8s-ns', 'FAConf', 
               'STCtx', 'az-id', 'tf-azimport', 'staterm', 'pim', 'pimDeactivate'
