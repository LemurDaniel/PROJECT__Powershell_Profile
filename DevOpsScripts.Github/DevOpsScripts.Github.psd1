...
FunctionsToExport = 'Invoke-GithubRest', 'Show-GithubEmojie', 'New-GithubBranch', 
               'New-GithubPullRequest', 'New-GithubRepository', 'Open-GithubBrowser', 
               'Open-GithubRepository', 'Add-GithubAccountContext', 
...
AliasesToExport = 'git-emojie', 'git-branch', 'git-pull', 'gitbrowser', 'gitvc', 'git-swa', 
               'git-swc'
