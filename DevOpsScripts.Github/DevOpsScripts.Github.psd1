...
FunctionsToExport = 'Invoke-GithubRest', 'Show-GithubEmojie', 'Add-GithubAccountContext', 
               ...
               'Get-GithubBranches', 'Get-GithubEmojies', 'Get-GithubEnvironments', 
               'Get-GithubIssues', 'Get-GithubPublicKey', 'Get-GithubReleases', 
               'Get-GithubRepositories', 'Get-GithubRepositorySecrets', 
               'Get-GithubRepositoryVariable', 
