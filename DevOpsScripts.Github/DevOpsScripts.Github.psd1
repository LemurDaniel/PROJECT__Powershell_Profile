...
FunctionsToExport = 'Invoke-GithubRest', 'Show-GithubEmojie', 'Add-GithubIgnore', 
               ...
               'Deploy-GithubSecretsTemplate', 'Get-GithubSecretsTemplate', 
               'Save-GithubSecretsTemplate', 'Set-GithubEnvironment', 
               'Set-GithubSecret', 'Set-GithubVariable', 'Get-GithubEnvironments', 
               'Get-GithubPublicKey', 'Get-GithubSecret', 'Get-GithubVariable', 
               ...
               'Invoke-GithubGenericValidateScript', 
               'Set-GithubOrganizationSecret', 'Set-GithubOrganizationVariable', 
               'Get-GithubOrganizationPublicKey', 'Get-GithubOrganizationSecret', 
               'Get-GithubOrganizationVariable', 'Get-GithubCache', 
