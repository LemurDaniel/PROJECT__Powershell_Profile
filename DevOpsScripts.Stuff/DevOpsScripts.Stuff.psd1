...
FunctionsToExport = 'Install-Software', 'Prompt', 'Push-Profile', 'Invoke-GitClone', 
               'Invoke-GitWrapper', 'Open-Repository', 'Start-Fireworks', 
               'Start-GenericGameLoop', 'Start-InvadersGame', 'Start-SnakeGame', 
               'New-TetrisGame', 'Get-DailyMsRewards', 'Get-MsRewards', 
               'Get-ScrambledText', 'Switch-Terraform', 'Get-DallEFromJoke', 
               'Get-OpenAIAPIAuthentication', 'Invoke-DalleRequest', 
               'Invoke-OpenAICompletion', 'Invoke-OpenAIImageGeneration', 
               'Invoke-OpenAIMoodToColor', 'Convert-SecretObject', 
               'Get-SecretFromStore', 'Get-SecretsFromStore', 'Get-SecretStore', 
               'Set-VersionActiveTF', 'Update-SecretStore', 'New-WindowBindings', 
               'New-WindowWPF', 'Get-BlenderFiles', 'Open-BlenderFile'
...
AliasesToExport = 'git-clone', 'git-wrapper', 'git-open', 'openAiImage', 'moodToColor'
