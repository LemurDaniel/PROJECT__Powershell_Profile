...
FunctionsToExport = 'Install-Software', 'Prompt', 'Push-Profile', 'Invoke-GitClone', 
               'Open-Repository', 'New-WindowBindings', 'New-WindowWPF', 
               'Get-BlenderFiles', 'Open-BlenderFile', 'Get-DallEFromJoke', 
               ...
               'Set-VersionActiveTF', 'Update-SecretStore', 'Get-DailyMsRewards', 
               'Get-MsRewards', 'Get-ScrambledText', 'Switch-Terraform', 
               'Start-Fireworks', 'Start-GenericGameLoop', 'Start-InvadersGame', 
               'Start-SnakeGame', 'New-TetrisGame'
...
AliasesToExport = 'git-clone', 'git-open', 'openAiImage', 'moodToColor'
